...
class PersistenceTests extends MySqlTestBase {
    ...
    void createWithMinimumContentLength() {
        ReviewEntity newEntity = new ReviewEntity(1, 4, "author", "subject", REVIEW_CONTENT_MIN, 4, LocalDate.now());
        repository.save(newEntity);
    ...
    void createWithMaximumContentLength() {
        ReviewEntity newEntity = new ReviewEntity(1, 5, "author", "subject", REVIEW_CONTENT_MAX, 4, LocalDate.now());
        repository.save(newEntity);
    ...
    void createWithMidRangeContentLength() {
        ReviewEntity newEntity = new ReviewEntity(1, 6, "author", "subject", REVIEW_CONTENT_MID, 4, LocalDate.now());
        repository.save(newEntity);
